...
которая в матрице 3х3 возвращает сумму элементов из главной диагонали. 
Эту сумму математики называют след матрицы.

С её помощью напишите программу, которая читает матрицу 3х3 и печатает 
